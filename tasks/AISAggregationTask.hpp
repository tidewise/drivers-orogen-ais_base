...
#ifndef AIS_BASE_AISAGGREGATIONTASK_TASK_HPP
#define AIS_BASE_AISAGGREGATIONTASK_TASK_HPP
...
namespace ais_base {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','ais_base::AISAggregationTask')
     end
     \endverbatim
    ...
    public:
         ...
         */
        AISAggregationTask(std::string const& name = "ais_base::AISAggregationTask");

        /** Default deconstructor of AISAggregationTask
         */
        ~AISAggregationTask();
